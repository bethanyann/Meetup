...
const credentials = {
  ...
  redirect_uris: ["https://bethanyann.github.io/meetup/"],
  javascript_origins: ["https://bethanyann.github.io", "http://localhost:3000"],
};
...
/* This is where the getAccessToken Lambda function will go */
...
module.exports.getCalendarEvents = async (event) => {
  ...
  // Decode authorization code extracted from the URL query
  const auth_token = decodeURIComponent(`${event.pathParameters.auth_token}`);
